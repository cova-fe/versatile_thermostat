...
class FeatureAutoStartStopManager(BaseFeatureManager):
    ...
    async def refresh_state(self) -> bool:
        ...
        if action == AUTO_START_STOP_ACTION.OFF and self._vtherm.is_on:
            ...
            self._vtherm.set_hvac_off_reason(HVAC_OFF_REASON.AUTO_START_STOP)
    ...
    def add_custom_attributes(self, extra_state_attributes: dict[str, Any]):
        ...
        if self.is_configured and self._auto_start_stop_algo:
            extra_state_attributes.update(
                {
    ...
    @property
    def auto_start_stop_level(self) -> AUTO_START_STOP_LEVEL:
